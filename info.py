...
API_ID = int(environ.get('API_ID', '21983955'))
...
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and support_chat_id.isdigit() else None
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001719724807')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1001719724807'))
